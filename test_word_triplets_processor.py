...
class TestWordTripletFunctions(unittest.TestCase):
    """Test functions for processor.py"""
    ...
    def test_can_open_text_file(self):
        ...
        opened = processor.text_open(["sample_text.txt"])
    ...
    def test_accepts_multiple_files(self):
        ...
        opened = processor.text_open(["sample_text.txt", "sample_text_too.txt"])
    ...
    def test_text_transform(self):
        ...
        processed_sample = processor.text_transform(transform_sample)
    ...
    def test_triple_counter_returns_list_of_tuples(self):
        ...
        count = processor.group_count(self.sample)
